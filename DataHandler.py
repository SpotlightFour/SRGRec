...
class DataHandler:
    ...
    def buildKGMatrix(self, kg_edges):
        ...
        kgMatrix = sp.csr_matrix((np.ones_like(edge_list[:, 0]), (edge_list[:, 0], edge_list[:, 1])), dtype='float64',
    ...
    def LoadData(self):
        ...
        self.diffusionData = DiffusionData(self.kg_matrix.toarray())
        self.diffusionLoader1 = dataloader.DataLoader(self.diffusionData, batch_size=args.batch, shuffle=True,
                                                      num_workers=0)
