...
def ParseArgs():
    ...
    # ========== 新增 VGAE 参数 ==========
    parser.add_argument('--vgae_hidden_dim', type=int, default=64, help='VGAE隐藏层维度')
    parser.add_argument('--vgae_num_layers', type=int, default=2, help='VGAE的RGAT层数')
    parser.add_argument('--beta_kl', type=float, default=0.001, help='VGAE中KL散度的权重')
